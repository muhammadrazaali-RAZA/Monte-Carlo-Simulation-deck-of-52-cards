...
### for Q2 Part: C  call by n experiment happend
numberOFexperiments = int(input("Enter number of Experiments on Consecutive Queen : "))   # part c
main(numberOFexperiments)    # part C